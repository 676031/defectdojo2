...
# DB vars
########################################################################
DB_TYPE=${DB_TYPE:-"PostgreSQL"}  # Valid options: SQLite, MySQL, PostgreSQL
DB_LOCAL=${DB_LOCAL:-"false"}
DB_EXISTS=${DB_EXISTS:-"false"}
DB_ROOT=${DB_ROOT:-"root"}
DB_NAME=${DB_NAME:-"defectdojo"}
DB_USER=${DB_USER:-"root"}
DB_PASS=${DB_PASS:-"root"}
DEV_DB_PASS="root"
#DEV_DB_PASS="vee0T%oanae1daeP%oz0ieka"
DB_HOST=${DB_HOST:-"34.69.250.196"}
...
ADMIN_EMAIL=${ADMIN_EMAIL:-"roman_batrak@epam.com"}
...
DD_DATABASE_URL=${DD_DATABASE_URL:-"postgres://root:root@34.69.250.196:5432/defectdojo"}  # Database URL, options: postgres://, mysql://, sqlite://, to use unsafe characters en>
#DD_DATABASE_HOST=${DD_DATABASE_HOST:-"34.69.250.196"}
...
DD_SECURE_SSL_REDIRECT=${DD_SECURE_SSL_REDIRECT:-"True"}  # If True, the SecurityMiddleware redirects all non-HTTPS requests to HTTPS - either True or False
